...
//===========================================================================================
  ...
  DebugTln("handle root file system ..");
  ...
  FSexplorerHTML += "</head>";
  FSexplorerHTML += "<body><h1>SPIFFSexplorer</h1><h2>Upload, Download of Verwijder</h2>";
...
//===========================================================================================
  ...
  redirectHTML += "</head>";
  redirectHTML += "<body><h1>"+String(_HOSTNAME)+" - SPIFFSexplorer</h1>";
...
//===========================================================================================
  ...
  return handleRoot();  // never delete
