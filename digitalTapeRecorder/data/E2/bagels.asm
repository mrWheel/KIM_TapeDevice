...
SECRET .EQU  $0000                  ; computer's secret code
WINDOW .EQU  $0004                  ; display window
INPUT  .EQU  $000a                  ; 4 player's input area
EXACT  .EQU  $000E                  ; # of exact matches
MATCH  .EQU  $000F                  ; # of other matches
POINTR .EQU  $0010                  ; digit being input
MOD    .EQU  $0011                  ; divisor/delay flag
RND    .EQU  $0012                  ; random number series
COUNT  .EQU  $0018                  ; number of guesses left
