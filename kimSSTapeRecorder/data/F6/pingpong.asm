;
;-- Ping Pong by Jim Butterfield
;

SPEED     .EQU  $80           ; speed ball travels
SPOT      .EQU  $81           ; segment(s)  ball lights
LOG       .EQU  $82           ; record of recent plays
PAUSE     .EQU  $83           ; delay before ball moves
DIRECT    .EQU  $84           ; direction of ball
PLACE     .EQU  $85           ; position of ball
SCORE     .EQU  $86
PLEFT     .EQU  $87           ; 0 for KIM to play left
PRITE     .EQU  $88           ; 0 for KIM to play right
DIGIT     .EQU  $89
ARG       .EQU  $8A
MOD       .EQU  $8B
TEMP      .EQU  $8C

;TMR1024  .EQU  $1704         ; KIM-1
TMR1024   .EQU  $1744         ; microKIM
SAD       .EQU  $1740
PADD      .EQU  $1741
SBD       .EQU  $1742
KEYIN     .EQU  $1F40
