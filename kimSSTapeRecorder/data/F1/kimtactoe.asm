...
DSPL    .EQU	 $BF
DISP    .EQU	 $BF
ROWS    .EQU	 $C8           ; CO-C8 PRESTORED RANDOM PLAYS
RS      .EQU	 $C8           ; CO-C8 PRESTORED RANDOM PLAYS
LPCNT   .EQU	 $D1           ; DELAY TIMER
IQ      .EQU	 $D2           ; I.Q.
R       .EQU	 $D3           ; RANDOM NUMBER REGISTERS
TEMP    .EQU	 $D9           ; TEMPORARY STORAGE
RATE    .EQU	 $DA           ; FLICKER / BLINK RATE
MODE    .EQU	 $DB           ; PLAY MODE
PS      .EQU	 $DB
SS      .EQU	 $BF
SQST    .EQU	 $BF
INH     .EQU	 $F9
