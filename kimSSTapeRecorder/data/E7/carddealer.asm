;
;-- card dealer by Dan Lewart
;
;-- will probably not work on the microKIM
;-- due to the use of both timers ($1704 and $1744)
;
START     .EQU  $1C4F
DDRA      .EQU  $1741 
TIMER44   .EQU  $1744
TMR1704   .EQU  $1704             ; KIM-1
...
NEWCRD: LDA     $0092           ; DECK FINISHED?
        BNE     RANDOM
        JMP     START           ; YES, STOP
RANDOM: LDA     TMR1704         ; GET RANDOM # (1-FF)
        BNE     FASTER
        LDA     TIMER44
        BNE     FASTER
